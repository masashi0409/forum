          ...
          <div class="px-10 mt-4">
              ...
              <div class="mt-4 mb-12">
                <form method="post" action="{{ route('comment.store')}}">
                    ...
                    <textarea name="body" class="bg-white w-full rounded-2xl px-4 mt-4 py-4 shadow-lg hover:shadow-2xl transition duration-500"
                    id="body" cols="30" rows="3" placeholder="コメントを入力してください">{{old('body')}}</textarea>
                    <x-primary-button class="float-right mr-4 mb-12 bg-teal-700">コメントをする</x-primary-button>
                </form>
              </div>
          </div>
      </div>
