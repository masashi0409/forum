<section>
    ...
    @else
        <form method="post" action="{{ route('profile.adminupdate', $user)}}" class="mt-6 space-y-6" enctype="multipart/form-data">
    @endif
        @csrf
        @method('patch')
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="bg-teal-700">{{ __('Save') }}</x-primary-button>
